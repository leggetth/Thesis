from nistsp80022tests import runs, cumulative_sums, approximate_entrophy, universal, serial
            ...
            for w3 in arange(0.0, 4/3, 1/3):
                for w4 in arange(0.0, 4/3, 1/3):
                    for w5 in arange(0.0, 4/3, 1/3):
                        sa = Sensitivity_Analysis([runs, cumulative_sums, approximate_entrophy, universal, serial],
                                                  w1, w2, w3, w4, w5)
